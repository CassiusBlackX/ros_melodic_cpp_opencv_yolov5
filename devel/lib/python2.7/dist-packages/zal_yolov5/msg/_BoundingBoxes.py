...
"""autogenerated by genpy from zal_yolov5/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
string Class"""
  ...
  _slot_types = ['std_msgs/Header','zal_yolov5/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = zal_yolov5.msg.BoundingBox()
        _x = val1
        start = end
        end += 40
