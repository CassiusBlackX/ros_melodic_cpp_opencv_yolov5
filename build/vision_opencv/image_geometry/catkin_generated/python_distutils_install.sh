...
echo_and_run cd "/home/nvidia/zal_ws/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nvidia/zal_ws/src/vision_opencv/image_geometry/setup.py" \
    egg_info --egg-base /home/nvidia/zal_ws/build/vision_opencv/image_geometry \
    build --build-base "/home/nvidia/zal_ws/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
